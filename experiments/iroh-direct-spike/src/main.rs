...
/// [`rendezvous::RENDEZVOUS_TTL_SECS`] so records never lapse while a pairing is active.
const RENDEZVOUS_REPUBLISH: Duration = Duration::from_secs(15 * 60);
/// How often to re-read the codes file to pick up newly created or revoked pairings.
