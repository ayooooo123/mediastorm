...
func DefaultHomeShelfConfigs() []ShelfConfig {
	return []ShelfConfig{
		...
		{ID: "my-recently-aired", Name: "My Recently Aired", Enabled: true, Order: 6, CalendarSources: CalendarSourceSettings{Watchlist: boolPtr(true), History: boolPtr(false), Trending: boolPtr(false), TopTrending: boolPtr(false), MDBLists: boolPtr(false)}},
		...
		{ID: "permanent-prequeue", Name: "Permanent Prequeue", Enabled: false, Order: 14},
	}
}
