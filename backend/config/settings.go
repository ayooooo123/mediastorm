...
type TorrentScraperConfig struct {
	...
	URL             string            `json:"url"`     // For Prowlarr/Jackett/Zilean/AIOStreams/Nyaa/Comet/MediaFusion/Internet Archive (full URL with config token if needed); PearTube relay URL
